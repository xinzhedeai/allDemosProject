    ...
    <div class="ratings-content">
      <div class="overview">
        <div class="overview-left">
          ...
          <div class="rank">高于周边商家{{seller.ratings}}</div>
        </div>
      ...
      <div class="rating-wrapper">
        <ul>
          <li class="rating-item" v-for="rating in ratings" v-show="needShow(rating.rateType, rating.text)" v-for="rating in food.ratings" class="rating-item">
            <div class="avatar">
  ...
  .ratings
    ...
    .overview
      ...
      .overview-left
        ...
        text-align center
        @media only screen and (max-width: 320px){ // iPhone5下，错位问题
           flex: 0 0 120px 
           width 120px
        }
        .score
